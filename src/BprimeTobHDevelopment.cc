...
void BprimeTobHDevelopment::beginJob() { 
  ...
  h_HT_NoCuts                  = fs->make<TH1D>("h_HT_NoCuts"                      ,"H_{T}[GeV]"                 ,4000 ,0.  ,4000.);
  h_pt_HiggsJets_NoCuts        = fs->make<TH1D>("h_HiggsJet_Pt_NoCuts"             ,"Higgs jet p_{T} [GeV]"      ,2000 ,0.  ,2000.);
  h_pt_BJets_NoCuts            = fs->make<TH1D>("h_BJet_Pt_NoCuts"                 ,"b jet p_{T} [GeV]"          ,2000 ,0.  ,2000.);
  ...
  h_HT_NoHiggsJetpTCut           = fs->make<TH1D>("h_HT_NoHiggsJetpTCut"             ,"H_{T}[GeV]"                ,4000 ,0.  ,4000.);
  h_pt_HiggsJets_NoHiggsJetpTCut = fs->make<TH1D>("h_HiggsJet_Pt_NoHiggsJetpTCut"    ,"Higgs jet p_{T} [GeV]"     ,2000 ,0.  ,2000.);
  h_pt_BJets_NoHiggsJetpTCut     = fs->make<TH1D>("h_BJet_Pt_NoHiggsJetpTCut"        ,"b jet p_{T} [GeV]"         ,2000 ,0.  ,2000.);
  ...
  h_HT_NoBJetpTCut              = fs->make<TH1D>("h_HT_NoBJetpTCut"                 ,"H_{T}[GeV]"                 ,4000 ,0.  ,4000.);
  h_pt_HiggsJets_NoBJetpTCut    = fs->make<TH1D>("h_HiggsJet_Pt_NoBJetpTCut"        ,"Higgs jet p_{T} [GeV]"      ,2000 ,0.  ,2000.);
  h_pt_BJets_NoBJetpTCut        = fs->make<TH1D>("h_BJet_Pt_NoBJetpTCut"            ,"b jet p_{T} [GeV]"          ,2000 ,0.  ,2000.);
  ...
  h_HT_NoNumberHiggsJetsCut           = fs->make<TH1D>("h_HT_NoNumberHiggsJetsCut"          ,"H_{T}[GeV]"                 ,4000 ,0.  ,4000.);
  h_pt_HiggsJets_NoNumberHiggsJetsCut = fs->make<TH1D>("h_HiggsJet_Pt_NoNumberHiggsJetsCut" ,"Higgs jet p_{T} [GeV]"      ,2000 ,0.  ,2000.);
  h_pt_BJets_NoNumberHiggsJetsCut     = fs->make<TH1D>("h_BJet_Pt_NoNumberHiggsJetsCut"     ,"b jet p_{T} [GeV]"          ,2000 ,0.  ,2000.);
  ...
  h_HT_NoNumberBJetsCut            = fs->make<TH1D>("h_HT_NoNumberBJetsCut"                  ,"H_{T}[GeV]"                 ,4000 ,0.  ,4000.);
  h_pt_HiggsJets_NoNumberBJetsCut  = fs->make<TH1D>("h_HiggsJet_Pt_NoNumberBJetsCut"         ,"Higgs jet p_{T} [GeV]"      ,2000 ,0.  ,2000.);
  h_pt_BJets_NoNumberBJetsCut      = fs->make<TH1D>("h_BJet_Pt_NoNumberBJetsCut"             ,"b jet p_{T} [GeV]"          ,2000 ,0.  ,2000.);
  ...
  h_HT_NoHTCut                  = fs->make<TH1D>("h_HT_NoHTCut"                      ,"H_{T}[GeV]"                 ,4000 ,0.   ,4000.);
  h_pt_HiggsJets_NoHTCut        = fs->make<TH1D>("h_HiggsJet_Pt_NoHTCut"             ,"Higgs jet p_{T} [GeV]"      ,2000 ,0.   ,2000.);
  h_pt_BJets_NoHTCut            = fs->make<TH1D>("h_BJet_Pt_NoHTCut"                 ,"b jet p_{T} [GeV]"          ,2000 ,0.   ,2000.);

  h_TrigStudySel_before_HT	        = fs->make<TH1D>("h_TrigStudySel_before_HT"          ,"H_{T}[GeV]"                 ,4000  ,0.   ,4000. );
  h_TrigStudySel_before_AK5HT       = fs->make<TH1D>("h_TrigStudySel_before_AK5HT"       ,"H_{T}[GeV]"                 ,4000  ,0.   ,4000. );
  h_TrigStudySel_before_HiggsJet_pT = fs->make<TH1D>("h_TrigStudySel_before_HiggsJet_pT" ,"Higgs jet p_{T} [GeV]"      ,2000  ,0.   ,2000. );
  h_TrigStudySel_before_bJet_pT     = fs->make<TH1D>("h_TrigStudySel_before_bJet_pT"     ,"b jet p_{T} [GeV]"          ,2000  ,0.   ,2000. );
  h_TrigStudySel_before_bJet_Eta    = fs->make<TH1D>("h_TrigStudySel_before_bJet_Eta"    ,"b jet #eta"                 ,50    ,-2.5 ,2.5   );
  h_TrigStudySel_HT		              = fs->make<TH1D>("h_TrigStudySel_HT"                 ,"H_{T}[GeV]"                 ,4000. ,0.   ,4000. );
  h_TrigStudySel_AK5HT              = fs->make<TH1D>("h_TrigStudySel_AK5HT"              ,"H_{T}[GeV]"                 ,4000. ,0.   ,4000. );
  h_TrigStudySel_HiggsJet_pT	      = fs->make<TH1D>("h_TrigStudySel_HiggsJet_pT"        ,"Higgs jet p_{T} [GeV]"      ,2000. ,0.   ,2000. );
  h_TrigStudySel_bJet_pT	          = fs->make<TH1D>("h_TrigStudySel_bJet_pT"            ,"b jet p_{T} [GeV]"          ,2000. ,0.   ,2000. );
  ...
  if ( doNminus1_ ) {
    ...
    if ( doAnalysis_ ) {
      for(int entry=0; entry<maxEvents_; entry++) {
        ...
        //DMbool CA8pre(false);
        //DMfor (int ifj=0; ifj < FatJetInfo.Size; ++ifj) {
        //DM  if ( FatJetInfo.Pt[ifj] > 100. ) {
        //DM    CA8pre = true;
        //DM    break;
        //DM  }
        //DM}
        //DMif( !CA8pre ) continue;

        //DMint AK5preCount(0);
        //DMfor (int ij=0; ij < JetInfo.Size; ++ij) {
        //DM  if ( JetInfo.Pt[ij] > 30. ) AK5preCount++;
        //DM}
        //DMif( AK5preCount < 2 ) continue;
        ...
        if (higgsJets.size() >= 1) {
          ...
          FillHisto(TString("HiggsJetSel")+TString("_nHJets"), higgsJets.size(), evtwt_) ;
          ...
          if (bJets.size() >= 2 ) { 
            ...
            //DM//// Trigger studies 
            //DMif ( TriggerStudyOn_ ) {
            //DM  h_TrigStudySel_before_HiggsJet_pT -> Fill(maxHiggspT ,evtwt_) ;
            //DM  h_TrigStudySel_before_bJet_pT     -> Fill(maxbpT ,evtwt_) ;
            //DM  h_TrigStudySel_before_bJet_Eta    -> Fill(maxbEta ,evtwt_) ;
            //DM  if ( passHLTTest ) {
            //DM    h_cutflow -> Fill("TriggerStudy", 1) ;
            //DM    h_TrigStudySel_HiggsJet_pT -> Fill(maxHiggspT ,evtwt_) ;
            //DM    h_TrigStudySel_bJet_pT     -> Fill(maxbpT ,evtwt_) ;
            //DM    h_TrigStudySel_bJet_Eta    -> Fill(maxbEta ,evtwt_) ;
            //DM  }
            //DM}
